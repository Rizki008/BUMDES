...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/front-end/styles/courses.css">
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/front-end/styles/courses_responsive.css">

	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/front-end/styles/about.css">
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/front-end/styles/about_responsive.css">
</head>