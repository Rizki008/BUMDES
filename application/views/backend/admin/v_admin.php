...
<div class="col-lg-3 col-6">
	...
	<div class="small-box bg-warning">
		...
		<a href="<?= base_url('user') ?>" class="small-box-footer">Jumlah User<i class="fas fa-arrow-circle-up"></i></a>
	</div>
</div>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<a href="<?= base_url('produk/edit/' . $value->id_produk) ?>" class="text-muted">
...
<div class="col-md-6">
	<div class="card">
		...
		<div class="card-footer clearfix">
			<a href="<?= base_url('admin/pesanan_masuk') ?>" class="btn btn-sm btn-secondary float-right">Lihat Semua Pesanan</a>
		</div>
		<!-- /.card-footer -->
	</div>
	<!-- /.card -->
