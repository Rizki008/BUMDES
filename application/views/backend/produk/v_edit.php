		...
		<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<select name="id_umkm" class="form-control">
							<option value="<?= $produk->id_umkm ?>"><?= $produk->nama_umkm ?></option>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label>Satuan </label>
						<input name="satuan" type="text" class="form-control" placeholder="Berat Produk" value="<?= $produk->satuan ?>">
					</div>
				</div>
				<div class="col-sm-3">
					<!-- text input -->
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						<img src="<?= base_url('assets/produk/' . $produk->img) ?>" id="gambar_load" width="400px">
					</div>
				</div>
			</div>
